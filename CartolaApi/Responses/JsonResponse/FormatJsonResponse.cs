...
public class JsonResponse
{
    ...
    /// <param name="status_code">O código de status HTTP a ser retornado com a resposta.</param>
    /// <returns>Uma tupla contendo o dicionário de resposta e o código de status.</returns>
    public static (Dictionary<string, object> Response, int StatusCode) JsonSuccessResponse(string status, object data, int status_code)
    {
    ...
    /// <param name="status_code">O código de status HTTP a ser retornado com a resposta.</param>
    /// <returns>Uma tupla contendo o dicionário de resposta e o código de status.</returns>
    public static (Dictionary<string, object> Response, int StatusCode) JsonErrorResponse(string status, object data, int status_code)
    {
        var response = new Dictionary<string, object>
        {
            { "status", status },
